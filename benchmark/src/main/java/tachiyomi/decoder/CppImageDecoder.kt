 ...
 */
class CppImageDecoder
private constructor(private val nativePtr: Long, val width: Int, val height: Int) {
    ...
    companion object {
        ...
        @JvmStatic private external fun nativeFindType(bytes: ByteArray): ImageType?
